require([
  ...
  fetch(configUrl)
    ...
    .then((config) => {
        ...
        view
          ...
          .then(function (screenshot) {
            ...
            <body>
                ...
                <div class="print-map">
                    <img id="print-map-image" src="${screenshot.dataUrl}" alt="Map Image" style=" height: auto; border: 3px solid #A9A9A9; margin: 0 0.75in;">
                </div>
      ...
      //       // Write the contents of the 'view' div into the new window
      //       printWindow.document.write(`
      //   <!DOCTYPE html>
      //   <html lang="en">
      //   <head>
      ...
      //       }
      //       #viewDiv {
      //         width: 100vw;  /* Set the width of the div to fill the page */
      //         height: 100vh; /* Set the height of the div to fill the page */
      //       }
      //     </style>
      //   </head>
      //   <body>
      //     <div id="viewDiv">${viewDiv.innerHTML}</div> <!-- Copy the contents of the 'view' div -->
      //     <script>
      //       window.onload = function() {
      //         window.print();
      //       };
